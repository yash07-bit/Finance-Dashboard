export default function BudgetHeader() {
  return (
    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 mb-10">
      ...
      <button className="bg-primary text-on-primary px-4 py-2.5 rounded-lg text-sm font-semibold shadow-md shadow-primary/20 hover:opacity-95 transition-all flex items-center gap-2 self-start sm:self-auto">
