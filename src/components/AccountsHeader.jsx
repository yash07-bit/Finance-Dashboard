...
export default function AccountsHeader({ totalLiquidity, changePct }) {
  ...
  return (
    <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
      ...
      <div>
        <button className="bg-primary text-white px-6 py-3 rounded-xl font-headline font-semibold flex items-center gap-2 hover:opacity-90 transition-all shadow-lg shadow-primary/10">
