export default function PageHeader({ totalTransactions = 0, onAddTransaction, canEdit = true }) {
  return (
    <div className="px-4 md:px-8 pt-4 md:pt-8 pb-4 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
      ...
      {canEdit ? (
        ...
        <div className="px-4 md:px-6 py-2 md:py-3 rounded-xl bg-slate-100 text-slate-500 font-semibold text-sm md:text-base whitespace-nowrap">
          Viewer mode
        </div>
      )}
    </div>
