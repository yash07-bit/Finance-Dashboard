export default function PageHeader({ totalTransactions = 0 }) {
  return (
    <div className="px-8 pt-8 pb-4 flex justify-between items-end">
      ...
      <button className="flex items-center gap-2 bg-primary text-on-primary px-6 py-3 rounded-xl font-headline font-semibold shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all">
