...
export default function SummaryCards({ metrics }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
      {/* Total Balance */}
      <div className="bg-gradient-finance p-4 md:p-6 rounded-xl shadow-md text-white group hover:shadow-lg transition-all duration-300">
        ...
        <h3 className="text-xl md:text-2xl lg:text-3xl font-bold mt-2">{formatCurrency(metrics.totalBalance)}</h3>
      </div>

      {/* Monthly Income */}
      <div className="bg-white p-4 md:p-6 rounded-xl shadow-md border border-border-light hover:shadow-lg transition-all duration-300">
        <div className="flex justify-between items-start mb-4">
        ...
        <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-success mt-2">{formatCurrency(metrics.monthlyIncome)}</h3>
      </div>
      ...
      <div className="bg-white p-4 md:p-6 rounded-xl shadow-md border border-border-light hover:shadow-lg transition-all duration-300">
        ...
        <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-primary mt-2">{formatCurrency(metrics.monthlyExpenses)}</h3>
      </div>
    </div>
  );
}
